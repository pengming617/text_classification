...
dicts = {}
with open("save_model/text_cnn/labels.txt", 'r', encoding="utf-8") as f:
...
class Infer(object):
    ...
    """
    def __init__(self):
        self.vocab_processor = learn.preprocessing.VocabularyProcessor.restore('save_model/text_cnn/vocab.pickle')
        self.checkpoint_file = tf.train.latest_checkpoint('save_model/text_cnn')
        graph = tf.Graph()
